...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="w-full py-8 border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 mt-auto">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-gray-600 dark:text-gray-400 text-xs font-medium tracking-wide">
            &copy; {currentYear} |
            <button
              type="button"
